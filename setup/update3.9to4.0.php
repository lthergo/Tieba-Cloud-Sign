...
',true);
    ...
    msg('您的云签到已成功升级到 V4.0 版本，请立即删除 /setup/update3.9to4.0.php，谢谢<br/><br/>若要获取 V4.0 版本新特性，请前往 <a href="https://lthergo.com/forum.php?mod=forumdisplay&fid=43">StusGame</a> ', SYSTEM_URL);
